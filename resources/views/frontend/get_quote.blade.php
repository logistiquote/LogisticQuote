                        ...
                        <div class="input-group">
                            ...
                            <div id="container_fields">
                                ...
                                <div class="form-row" id="add_remove_containers" style="display: flex">
                                    <button type="button" class="request-btn btn-sm manage-button-styles" id="add_container">
                                        <i class="fal fa-plus"></i>
                                    </button>
                                    <button type="button" class="request-btn btn-sm manage-button-styles" id="remove_container">
