                            ...
                            <tr>
                                ...
                                <td>
                                    @if($quotation->route)
                                        ...
                                        to
                                        <span
                                            class="text-danger">{{ $quotation->route?->full_destination_location }}</span>
                                    @elseif($quotation->shipment)
                                        <span
                                            class="text-success">{{ $quotation->shipment?->full_origin_location }}</span>
                                        to
                                        <span
                                            class="text-danger">{{ $quotation->shipment?->full_destination_location }}</span>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    @if(!$quotation->is_paid && $quotation->can_be_paid)
                                        ...
                                        <div class="mt-1">
                                            <button class="btn btn-primary" id="showInfoButton" data-bs-toggle="modal"
                                                    data-bs-target="#ibanInfoModal">
                                                Show IBAN Info
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="ibanInfoModal" tabindex="-1"
                                                 aria-labelledby="ibanInfoModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="ibanInfoModalLabel">Bank account
                                                                details</h5>
                                                        </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{ route('quotation.edit', $quotation->id) }}">View</a>
                                            <a class="dropdown-item"
                                               href="{{ route('quotation.summary.download', $quotation->id) }}">Download
                                                Summary</a>
                                        </div>
                                    </div>
